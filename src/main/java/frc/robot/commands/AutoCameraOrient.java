...
public class AutoCameraOrient extends CommandBase {
  @SuppressWarnings({"PMD.UnusedPrivateField", "PMD.SingularField"})
  private final CameraInfo cameraInfo;
  private final DriveTrain driveTrain;
  double XChange = 0;
  
  public AutoCameraOrient(CameraInfo cI, DriveTrain cM) {
    cameraInfo = cI;
    driveTrain = cM;
  ...
  public void execute() { 
    ...
    System.out.println("XChange Value: " + Math.abs(XChange));
